...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            ...
            ApplicationContext factory = new ClassPathXmlApplicationContext("classpath:tripXMLClient.xml");
            TripServices tripServices = (TripServices) factory.getBean("tripServices");
